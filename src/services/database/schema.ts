...
export const expenses = sqliteTable(
  "expenses",
  {
    ...
    receipt_attached: integer("receipt_attached", { mode: "boolean" })
      .notNull()
      .default(false),
    receipt_file_path: text("receipt_file_path"),
    tax_relevant: integer("tax_relevant", { mode: "boolean" })
      .notNull()
      .default(true),
...
export const kpiRecords = sqliteTable(
  ...
  (table) => [
    index("idx_kpi_records_period").on(table.period_type, table.period_start),
  ],
);
